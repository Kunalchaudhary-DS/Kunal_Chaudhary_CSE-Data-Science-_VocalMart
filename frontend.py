...
class MainScreen(BoxLayout):
    def __init__(self,**kwargs):
        ...
        self.title_label=Label(text="Inventory Assistant",font_size=26,color=(0,0,0,1),size_hint_y=None,height=40)
        self.subtitle_label=Label(text="How can I assist you today?",font_size=18,color=(0.3,0.3,0.3,1),size_hint_y=None,height=30)
        ...
        self.response_label=Label(text="I'm ready to help you!",font_size=16,color=(0.2, 0.2, 0.2, 1),size_hint=(1, None),height=100,halign='center',valign='middle')
        self.response_label.bind(size=self.response_label.setter('text_size'))

        self.user_input=TextInput(hint_text="Enter your command...",font_size=16,multiline=False)
        ...
        self.db_label=Label(text="Connected to database",font_size=12,color=(0,0.6,0,1),size_hint_y=None,height=20)
    ...
    def process_command(self,command):
        ...
        Clock.schedule_once(lambda dt:self.get_backend_response(command),1)

    def get_backend_response(self,command):
    ...
    def call_update_stock(self):
        try:
            ...
            self.response_label.text="Stock updated!"
        except Exception as e:
            self.response_label.text=f"Error:{e}"
    ...
    def call_view_dataset(self):
        try:
            ...
            self.response_label.text="Database opened!"
        except Exception as e:
            self.response_label.text=f"Error: {e}"
